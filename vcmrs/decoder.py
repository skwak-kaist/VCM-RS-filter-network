...
def get_arguments():
  ...
  # post filter network parameters
  parser.add_argument('--JointFilter', type=str, default='filter', help='Joint filtering')
  parser.add_argument('--JointFilterPostModel', type=str, default='Identity', choices=['Identity', 'FilterV8'])
...
def decode(args):
  ...
  #post_components += ['FormatAdapter'] # no format adapter in stand-alone decoder
